...
function handleTextColor() {
    ...
    Utils.putStyle('body-text-color', `
        ...
        .coursesummary,.edw-card-design-ft .lesson-count , .coursesummary,.category-description-wrapper,
        ...
        .small-info-regular,
        .small-info-semibold,
        #latest_members .user-info-wrapper .users-list-date,.item-due-date{
